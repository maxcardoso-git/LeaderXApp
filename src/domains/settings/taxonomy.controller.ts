  ...
  async create(
    ...
    return this.prisma.systemCapability.create({
      data: {
        ...
        forbiddenFlags: dto.forbiddenFlags ?? [],
        fixedArgs: dto.fixedArgs,
        sanitizationRules: dto.sanitizationRules,
        timeout: dto.timeout,
        maxTimeout: dto.maxTimeout,
        retryPolicy: dto.retryPolicy,
        rateLimitPerMin: dto.rateLimitPerMin,
        requiresApproval: dto.requiresApproval ?? false,
        cacheEnabled: dto.cacheEnabled ?? false,
        cacheExpirationHours: dto.cacheExpirationHours,
        auditEnabled: dto.auditEnabled ?? true,
        auditLevel: dto.auditLevel ?? 'BASIC',
        metadata: dto.metadata ?? {},
        tags: dto.tags ?? [],
        isActive: dto.isActive ?? true,
      },
  ...
  async update(
    ...
    return this.prisma.systemCapability.update({
      ...
      data: {
        ...
        inputSchema: dto.inputSchema,
        outputSchema: dto.outputSchema,
        forbiddenFlags: dto.forbiddenFlags !== undefined ? dto.forbiddenFlags : undefined,
        fixedArgs: dto.fixedArgs !== undefined ? dto.fixedArgs : undefined,
        sanitizationRules: dto.sanitizationRules !== undefined ? dto.sanitizationRules : undefined,
        timeout: dto.timeout,
        maxTimeout: dto.maxTimeout !== undefined ? dto.maxTimeout : undefined,
        retryPolicy: dto.retryPolicy,
        rateLimitPerMin: dto.rateLimitPerMin !== undefined ? dto.rateLimitPerMin : undefined,
        requiresApproval: dto.requiresApproval !== undefined ? dto.requiresApproval : undefined,
        cacheEnabled: dto.cacheEnabled,
        cacheExpirationHours: dto.cacheExpirationHours,
        auditEnabled: dto.auditEnabled !== undefined ? dto.auditEnabled : undefined,
        auditLevel: dto.auditLevel !== undefined ? dto.auditLevel : undefined,
        metadata: dto.metadata,
        tags: dto.tags,
